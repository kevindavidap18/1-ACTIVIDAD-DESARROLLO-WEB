...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (strlen($password) < 12) {
        ...
        header('Location: /ACTIVIDAD_DESARROLLO_1/Views/Html/LoginForms/register.php?message=password_length');
        exit();
    }
    ...
    try {
        ...
        header('Location: /ACTIVIDAD_DESARROLLO_1/Views/Html/LoginForms/Login.php?message=success');
        exit();
    } catch (UsuarioEncontradoException $e) {
        // Redirigir a la página de registro con mensaje de error
        header('Location:  /ACTIVIDAD_DESARROLLO_1/Views/Html/LoginForms/register.php?message=exists');
        exit();
    } catch (Exception $e) {
        echo $e->getMessage();
    }
